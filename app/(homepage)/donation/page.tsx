export default function Page() {
  return (
    <div className="min-h-screen ">
      ...
      <div className="flex flex-col lg:flex-row w-full lg:mx-10 gap-5 lg:gap-20">
        {/* Left Column */}
        <div className="w-full lg:w-1/3 flex lg:justify-center">
          <div className="w-full lg:p-6 max-w-md mx-8 lg:ml-0">
            <p>
        ...
        {/* Right Column */}
        <div className="bg-white w-full lg:w-2/3 pt-8 lg:p-8 rounded-3xl text-center border-4">
      ...
      <p className="text-center text-base text-red-500 mt-10 lg:mt-24">
