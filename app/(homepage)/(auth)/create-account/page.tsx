        ...
        <form action={dispatch} className="flex flex-col gap-4">
          ...
          <div className="mt-4">
            ...
            <div>
              ...
              {showModal && <AgreementModal onClose={clickModal} />}
            </div>
          </div>
  ...
  return (
    ...
    >
      <div
        ...
        className="bg-white text-black flex flex-col rounded-2xl p-4 w-full max-w-lg h-full max-h-[90vh] overflow-y-auto z-50"
      >
